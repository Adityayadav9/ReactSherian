...
// import  './App.css'. not need to import css file again and again in every component. just import once in index.js file
import './App.css'
...
const App = () => {
  ...
  return (
   ...
   {arr.map(function(elem, idx){
    return <div key={idx}>
      <Card  company={elem.companyName}  post={elem.post} tag1={elem.tag1} tag2={elem.tag2} datePosted={elem.datePosted} brandLogo={elem.brandLogo} pay={elem.pay} location={elem.location}/>
      </div>
   })}
